...
//parmanent address
$par_division=isset($_POST["par_division"])?$_POST["par_division"]:'';

$par_district=isset($_POST["par_district"])?$_POST["par_district"]:'';
$par_police_station=isset($_POST["par_police_station"])?$_POST["par_police_station"]:'';
$par_post_office=isset($_POST["par_post_office"])?$_POST["par_post_office"]:'';
$par_village_road=isset($_POST["par_village_road"])?$_POST["par_village_road"]:'';
$par_house=isset($_POST["par_house"])?$_POST["par_house"]:'';

//present address

	$pre_division=isset($_POST["pre_division"])?$_POST["pre_division"]:'';
	$pre_district=isset($_POST["pre_district"])?$_POST["pre_district"]:'';
	$pre_police_station=isset($_POST["pre_police_station"])?$_POST["pre_police_station"]:'';
	$pre_post_office=isset($_POST["pre_post_office"])?$_POST["pre_post_office"]:'';
	$pre_village_road=isset($_POST["pre_village_road"])?$_POST["pre_village_road"]:'';
	$pre_house=isset($_POST["pre_house"])?$_POST["pre_house"]:'';

//academic information

	$ssc=isset($_POST["ssc"])?$_POST["ssc"]:'';
	$ssc_board=isset($_POST["ssc_board"])?$_POST["ssc_board"]:'';
	$ssc_exam_year=isset($_POST["ssc_exam_year"])?$_POST["ssc_exam_year"]:'';
	$ssc_group=isset($_POST["ssc_group"])?$_POST["ssc_group"]:'';
	$ssc_roll=isset($_POST["ssc_roll"])?$_POST["ssc_roll"]:'';
	$ssc_regi=isset($_POST["ssc_registration"])?$_POST["ssc_registration"]:'';
  $ssc_with_point=isset($_POST["ssc_with_optional"])?$_POST["ssc_with_optional"]:'';
  $ssc_without_point=isset($_POST["ssc_without_optional"])?$_POST["ssc_without_optional"]:'';

	$hsc=isset($_POST["hsc"])?$_POST["hsc"]:'';
	$hsc_board=isset($_POST["hsc_board"])?$_POST["hsc_board"]:'';
	$hsc_exam_year=isset($_POST["hsc_exam_year"])?$_POST["hsc_exam_year"]:'';
	$hsc_group=isset($_POST["hsc_group"])?$_POST["hsc_group"]:'';
	$hsc_roll=isset($_POST["hsc_roll"])?$_POST["hsc_roll"]:'';
	$hsc_regi=isset($_POST["hsc_registration"])?$_POST["hsc_registration"]:'';
  $hsc_with_point=isset($_POST["hsc_with_optional"])?$_POST["hsc_with_optional"]:'';
  $hsc_without_point=isset($_POST["hsc_without_optional"])?$_POST["hsc_without_optional"]:'';


	$department_1=isset($_POST["department_1"])?$_POST["department_1"]:'';
	$department_2=isset($_POST["department_2"])?$_POST["department_2"]:'';
	$department_3=isset($_POST["department_3"])?$_POST["department_3"]:'';
	$department_4=isset($_POST["department_4"])?$_POST["department_4"]:'';
...
//	  if($s_email==true && $s_phone==true && $ssc_roll==true && $hsc_roll==true && $s_username==true && $s_password==true ){
	...
	$admission_form_update=new admission_apply(
$s_f_name,
$s_l_name,
$father_name,
$mother_name,
...
$photo_extension);
	 ...
	 $admission_form_update->admission_apply_form_update($update_id);
	 if($update_id){
	 	echo "<br>$update_id<br>";
...
/*
	 ...
	 if($db->insert_id){
	  ...
	  $db->query("update admission_form_update set photo='$db->insert_id.$photo_extension' where id='$db->insert_id'");
