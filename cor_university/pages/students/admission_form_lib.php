...
//$db->insert_id='';
   $admission_apply_success=$admission_apply->background_examination_save($admission_apply_id);
   if($admission_apply_success){
    $_SESSION["student_admission_success"]='<pre><h2>your Apply is successfull <br> Thank you For Apply and Welcome Our UNIVERSITY</h2><pre>';
