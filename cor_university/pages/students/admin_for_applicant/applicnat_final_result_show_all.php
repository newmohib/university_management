...
$applicant_department_submit=isset($_POST['applicant_department_submit'])?$_POST['applicant_department_submit']:'';
...
if ($applicant_department_submit) {
 ...
 //$applicant_id=$_POST['applicant_id'];
  ...
  if(isset($department_id)){
           ...
           $applicant_result_show_ind_1=$db->query("select id,applicant_id,mark,total_gpa_with_optional,total_gpa_without_optional,total_mark,total_result_with_optional,total_result_without_optional,status,department,user_id,update_date,merit_position from {$ext}applicant_result where department='$department_id' ORDER BY merit_position ASC");
   ...
   //basic data         
            $applicant_basic_information_show=$db->query("select s.id,s.s_f_name,s.s_l_name,s.photo,d.name from {$ext}admission_apply s,{$ext}department d where s.id='$applicant_id' and d.id='$department_id'");
...
echo $applicant_all_result_top;
        ...
        while(list($id,$applicant_id,$mark,$total_gpa_with_optional,$total_gpa_without_optional,$total_mark,$total_result_with_optional,$total_result_without_optional,$status,$department,$user_id,$update_date,$merit_position)=$applicant_result_show_ind->fetch_row()){
 ...
 <table class="table table-striped table-hover my_applicant_table">
                      ...
                      <thead>
                        <tr class="table-success">
                          ...
                          <th>Department Merit Position</th>
