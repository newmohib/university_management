...
$session_appli=isset($_SESSION["app_id"])?$_SESSION["app_id"]:'';

// if($session_appli==false){
//     header("location:applicant_login.php");
    
//   }

$page=isset($_GET["page"])?$_GET["page"]:'';
$edit=isset($_GET["apply"])?$_GET["apply"]:'';
$update_id_self=isset($_GET["self_id"])?$_GET["self_id"]:'';
$admin_edit_applicant=isset($_POST['admin_edit_applicant'])?$_POST['admin_edit_applicant']:'';
$update_applicant_id_admin=isset($_POST['applicant_id'])?$_POST['applicant_id']:'';

if($page || $admin_edit_applicant){
$applicant=$page;



if($update_id_self){
  $update_id=$update_id_self;
}else if(isset($_SESSION["app_id"])){
   $update_id=$_SESSION["app_id"];
}else{
   $update_id=$update_applicant_id_admin;
}
                            ...
                            <div class="form-group-material i-checks ">
                              <?php if(isset($photo)){
                                $file_loc="pages/students/img/".$photo;
                                 echo "<img src='$file_loc' height='250' width='250' alt='Image preview...' id='s_photo' class='img-fluid rounded-circle'/>";
