...
//if(!isset($_SESSION["app_id"])){
 //    header("location:pages/students/applicant_login.php");
 //  }
            ...
            $applicant_id=isset($applicant_id)?$applicant_id:'';
                    ...
                    <form action="index.php" method="post">
                        <div class="col-lg-11 col-md-11  col-sm-10">
                            <div class="form-group-material">
                                <input id="applicant_payment" type="hidden" name="applicant_payment_self_id" required class="input-material" value="$id">
                                 
                                <label for="applicant_paiment" class="label-material">Applicant ID</label><h3>$id</h3>
                            </div>
                            <div class="form-group-material">
