                            ...
                            <div class="col-md-6">
                              ...
                              <div class="col-lg-12 col-sm-12 col-mb-12">
                               <select name="country" class="form-control">
                                      ...
                                      <?php
                    // $db = new mysqli("localhost","root","","test");
                     $add_countries = $db->query("select id,country_name from apps_countries");
        ...
        <div class="card-body">
          ...
          <!--===========guardian start=========-->
                 ...
                 <div class="row">
                      <div class="col-lg-6 col-sm-6 col-mb-6">
                            <div class="form-group-material i-checks ">
                                <input id="aplly_submit" type="submit" name="aplly_submit" required class="input-material" value="SUBMIT">
