...
<html lang="en">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
    <div class="container">
      <a class="navbar-brand" href="index.php"><i class="flaticon-university"></i>WORLD<br><small>University</small></a>
      ...
      <div class="collapse navbar-collapse" id="ftco-nav">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item"><a href="cor_university/pages/login/login.php" class="nav-link">Admin</a></li>
          <li class="nav-item"><a href="cor_university/pages/students/applicant_login.php" class="nav-link">Aplicant</a></li>
          <li class="nav-item"><a href="cor_university/pages/students_final/student_login.php" class="nav-link">Student</a></li>
          <li class="nav-item"><a href="cor_university" class="nav-link">guardine</a></li>
          <li class="nav-item"><a href="cor_university" class="nav-link">Events</a></li>
          <li class="nav-item"><a href="contact.html" class="nav-link">Contact</a></li>
          <li class="nav-item cta"><a href="cor_university?page=applicant&apply=form" class="nav-link"><span>Apply Now!</span></a></li>
          <li class="nav-item cta"><a href="cor_university/pages/students/applicant_login.php" class="nav-link px-2 py-2" style="background-color: skyblue; border:none;"><span>Applicant Login</span></a></li>
        </ul>
      </div>
    </div>
  </nav>
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center" data-scrollax-parent="true">
          <div class="col-md-8 ftco-animate text-center">
            ...
            <p>
              <form action="cor_university/index.php" method="post">
                <input type="submit" name="applicant_result_show_indivitual" value="Result Show" class="btn btn-primary btn-lg active"  aria-pressed="true" style="border-radius: 40%;">
                            
              </form>
              <a href="#" class="btn btn-info px-4 py-3" style="margin-top: 10px;">View Courses</a></p>
          </div>
        </div>
      </div>
    </div>
    	...
    	<div class="container">
    		<div class="row d-md-flex justify-content-center">
    			<div class="col-md-9 about-video text-center">
    				<h2 class="ftco-animate">WORLD University is a Leading Schools Around the World</h2>
